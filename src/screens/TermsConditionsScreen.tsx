...
export default function TermsConditionsScreen() {
  useSeo({
    title: 'Terms of Use | Viora Media',
    description: 'Read the Terms of Use of Viora Media. Understand the rules, services, intellectual property agreements, and user responsibilities.'
  });
    ...
    <div className="w-full bg-black min-h-screen pt-12 pb-24 text-white">
      <section className="max-w-4xl mx-auto px-6 py-16">
        ...
        <h1 className="font-serif text-4xl md:text-6xl text-white tracking-wide mt-4 mb-2">
          Terms <span className="text-gold-gradient font-italic font-normal">of Use</span>
        </h1>
        ...
        <div className="space-y-12 text-sm md:text-base text-accent-muted font-light leading-relaxed tracking-wide font-sans">
          ...
          <div className="space-y-4">
            <h2 className="font-serif text-2xl text-white tracking-wide">AGREEMENT TO OUR LEGAL TERMS</h2>
            <p>We are Viora Media ("Company," "we," "us," "our").</p>
            <p>We operate [website/service details], as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").</p>
            <p>You can contact us by email at <a href="mailto:contact@vioramedia.in" className="text-secondary hover:text-white transition-colors duration-300">contact@vioramedia.in</a>.</p>
            <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and Viora Media, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
          ...
          <div className="border-l border-secondary/20 pl-6 space-y-4">
            <h2 className="font-serif text-xl text-white tracking-wide">1. OUR SERVICES</h2>
            <p>The information provided when using the Services is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country. Accordingly, those persons who choose to access the Services from other locations do so on their own initiative and are solely responsible for compliance with local laws, if and to the extent local laws are applicable.</p>
          </div>

          {/* Section 2 */}
          <div className="border-l border-secondary/20 pl-6 space-y-4">
            <h2 className="font-serif text-xl text-white tracking-wide">2. INTELLECTUAL PROPERTY RIGHTS</h2>
            <h3 className="text-white font-medium">Our intellectual property</h3>
            ...
            <h3 className="text-white font-medium mt-6">Your use of our Services</h3>
            ...
            <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:contact@vioramedia.in" className="text-secondary hover:text-white transition-colors duration-300">contact@vioramedia.in</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
            <p>We reserve all rights not expressly granted to you in and to the Services, Content, and Marks.</p>
            <p>Any breach of these Intellectual Property Rights will constitute a material breach of our Legal Terms and your right to use our Services will terminate immediately.</p>
            
            <h3 className="text-white font-medium mt-6">Your submissions</h3>
          ...
          {/* Section 3 */}
          <div className="border-l border-secondary/20 pl-6 space-y-4">
            <h2 className="font-serif text-xl text-white tracking-wide">3. USER REPRESENTATIONS</h2>
          ...
          {/* Section 4 */}
          <div className="border-l border-secondary/20 pl-6 space-y-4">
            <h2 className="font-serif text-xl text-white tracking-wide">4. PROHIBITED ACTIVITIES</h2>
          ...
          {/* Section 5 */}
          <div className="border-l border-secondary/20 pl-6 space-y-4">
            <h2 className="font-serif text-xl text-white tracking-wide">5. USER GENERATED CONTRIBUTIONS</h2>
          ...
          {/* Section 6 */}
          <div className="border-l border-secondary/20 pl-6 space-y-4">
            <h2 className="font-serif text-xl text-white tracking-wide">6. CONTRIBUTION LICENSE</h2>
          ...
          {/* Section 7 */}
          <div className="border-l border-secondary/20 pl-6 space-y-4">
            <h2 className="font-serif text-xl text-white tracking-wide">7. SERVICES MANAGEMENT</h2>
          ...
          {/* Section 8 */}
          <div className="border-l border-secondary/20 pl-6 space-y-4">
            <h2 className="font-serif text-xl text-white tracking-wide">8. TERM AND TERMINATION</h2>
          ...
          {/* Section 9 */}
          <div className="border-l border-secondary/20 pl-6 space-y-4">
            <h2 className="font-serif text-xl text-white tracking-wide">9. MODIFICATIONS AND INTERRUPTIONS</h2>
          ...
          {/* Section 10 */}
          <div className="border-l border-secondary/20 pl-6 space-y-4">
            <h2 className="font-serif text-xl text-white tracking-wide">10. GOVERNING LAW</h2>
            <p>These Legal Terms shall be governed by and defined following the laws of India. Viora Media and yourself irrevocably consent that the courts of Chennai, Tamil Nadu, India shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.</p>
          </div>

          {/* Section 11 */}
          <div className="border-l border-secondary/20 pl-6 space-y-4">
            <h2 className="font-serif text-xl text-white tracking-wide">11. DISPUTE RESOLUTION</h2>
            <h3 className="text-white font-medium">Informal Negotiations</h3>
            <p>To expedite resolution and control the cost of any dispute, controversy, or claim related to these Legal Terms (each a "Dispute" and collectively, the "Disputes") brought by either you or us (individually, a "Party" and collectively, the "Parties"), the Parties agree to first attempt to negotiate any Dispute (except those Disputes expressly provided below) informally for at least 30 days before initiating arbitration. Such informal negotiations commence upon written notice from one Party to the other Party.</p>
            <h3 className="text-white font-medium mt-6">Binding Arbitration</h3>
            <p>If the parties are unable to resolve the dispute through informal negotiation, the dispute shall be finally resolved by arbitration in accordance with the United Nations Commission on International Trade Law Arbitration Rules in force at the time of commencement of the arbitration. The number of arbitrators shall be one (1). The seat, or legal place, of arbitration shall be Chennai, Tamil Nadu, India. The language of the proceedings shall be English. The governing law of these Legal Terms shall be substantive law of India.</p>
            <h3 className="text-white font-medium mt-6">Restrictions</h3>
            <p>The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilize class action procedures; and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the general public or any other persons.</p>
            <h3 className="text-white font-medium mt-6">Exceptions to Informal Negotiations and Arbitration</h3>
          ...
          {/* Section 12 */}
          <div className="border-l border-secondary/20 pl-6 space-y-4">
            <h2 className="font-serif text-xl text-white tracking-wide">12. CORRECTIONS</h2>
            <p>There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.</p>
          </div>

          {/* Section 13 */}
          <div className="border-l border-secondary/20 pl-6 space-y-4">
            <h2 className="font-serif text-xl text-white tracking-wide">13. DISCLAIMER</h2>
            ...
            <p className="uppercase">WE MAKE NO WARRANTIES OR REPRESENTATIONS ABOUT THE ACCURACY OR COMPLETENESS OF THE SERVICES' CONTENT OR THE CONTENT OF ANY WEBSITES OR MOBILE APPLICATIONS LINKED TO THE SERVICES AND WE WILL ASSUME NO LIABILITY OR RESPONSIBILITY FOR ANY:</p>
            <ol className="list-decimal pl-5 space-y-2 uppercase">
            ...
            <p className="uppercase">WE DO NOT WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY FOR ANY PRODUCT OR SERVICE ADVERTISED OR OFFERED BY A THIRD PARTY THROUGH THE SERVICES, ANY HYPERLINKED WEBSITE, OR ANY WEBSITE OR MOBILE APPLICATION FEATURED IN ANY BANNER OR OTHER ADVERTISING, AND WE WILL NOT BE A PARTY TO OR IN ANY WAY BE RESPONSIBLE FOR MONITORING ANY TRANSACTION BETWEEN YOU AND ANY THIRD-PARTY PROVIDERS OF PRODUCTS OR SERVICES. AS WITH THE PURCHASE OF A PRODUCT OR SERVICE THROUGH ANY MEDIUM OR IN ANY ENVIRONMENT, YOU SHOULD USE YOUR BEST JUDGMENT AND EXERCISE CAUTION WHERE APPROPRIATE.</p>
          </div>


          {/* Section 14 */}
          <div className="border-l border-secondary/20 pl-6 space-y-4">
            <h2 className="font-serif text-xl text-white tracking-wide">14. INDEMNIFICATION</h2>
          ...
          {/* Section 15 */}
          <div className="border-l border-secondary/20 pl-6 space-y-4">
            <h2 className="font-serif text-xl text-white tracking-wide">15. USER DATA</h2>
            <p>We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.</p>
          </div>

          {/* Section 16 */}
          <div className="border-l border-secondary/20 pl-6 space-y-4">
            <h2 className="font-serif text-xl text-white tracking-wide">16. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
            ...
            <p className="uppercase">YOU HEREBY AGREE TO THE USE OF ELECTRONIC SIGNATURES, CONTRACTS, ORDERS, AND OTHER RECORDS, AND TO ELECTRONIC DELIVERY OF NOTICES, POLICIES, AND RECORDS OF TRANSACTIONS INITIATED OR COMPLETED BY US OR VIA THE SERVICES. <span className="normal-case">You hereby waive any rights or requirements under any statutes, regulations, rules, ordinances, or other laws in any jurisdiction which require an original signature or delivery or retention of non-electronic records, or to payments or the granting of credits by any means other than electronic means.</span></p>
          </div>

          {/* Section 17 */}
          <div className="border-l border-secondary/20 pl-6 space-y-4">
            <h2 className="font-serif text-xl text-white tracking-wide">17. MISCELLANEOUS</h2>
          ...
          {/* Section 18 */}
          <div className="border-l border-secondary/20 pl-6 space-y-4">
            <h2 className="font-serif text-xl text-white tracking-wide">18. CONTACT US</h2>
            <p>In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at:</p>
            <a href="mailto:contact@vioramedia.in" className="inline-block text-secondary hover:text-white transition-colors duration-300 font-serif italic text-lg">contact@vioramedia.in</a>
          </div>
